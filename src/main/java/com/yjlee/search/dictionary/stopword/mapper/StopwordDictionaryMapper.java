...
public interface StopwordDictionaryMapper {
    ...
    StopwordDictionary toEntity(StopwordDictionaryCreateRequest request, DictionaryEnvironmentType environment);
    ...
    StopwordDictionary copyWithEnvironment(StopwordDictionary source, DictionaryEnvironmentType targetEnvironment);
}