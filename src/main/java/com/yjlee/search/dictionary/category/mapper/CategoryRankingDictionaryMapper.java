...
public interface CategoryRankingDictionaryMapper {
  ...
  @Mapping(
      target = "categoryMappings",
      expression =
          "java(CategoryRankingDictionaryResponse.convertMappings(entity.getCategoryMappings()))")
  CategoryRankingDictionaryResponse toResponse(CategoryRankingDictionary entity);

  @Mapping(
      target = "categoryCount",
      expression =
          "java(entity.getCategoryMappings() != null ? entity.getCategoryMappings().size() : 0)")
