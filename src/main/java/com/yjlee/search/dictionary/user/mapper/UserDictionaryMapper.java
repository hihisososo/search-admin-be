...
public interface UserDictionaryMapper {
    ...
    UserDictionary toEntity(UserDictionaryCreateRequest request, DictionaryEnvironmentType environment);
    ...
    UserDictionary copyWithEnvironment(UserDictionary source, DictionaryEnvironmentType targetEnvironment);
}