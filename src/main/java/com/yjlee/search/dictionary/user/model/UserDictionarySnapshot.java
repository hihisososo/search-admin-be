...
@Entity
@Table(name = "user_dictionary_snapshots")
...
public class UserDictionarySnapshot implements DictionarySnapshotEntity {
  ...
  // 스냅샷 생성 편의 메서드
  public static UserDictionarySnapshot createSnapshot(
      DictionaryEnvironmentType environmentType, UserDictionary dictionary) {
  ...
  // 환경별 스냅샷 업데이트
  public void updateSnapshot(UserDictionary dictionary) {
