...
public class SearchBoostConstants {
  ...
  // Phrase 부스팅 값
  public static final float NAME_PHRASE_BOOST = 5.0f;
  public static final float SPECS_PHRASE_BOOST = 2.0f;
  public static final float MODEL_PHRASE_BOOST = 3.0f;
  public static final float CATEGORY_PHRASE_BOOST = 1.0f;

  // Match 부스팅 값
  public static final float MODEL_MATCH_BOOST = 8.0f;
  public static final float UNIT_MATCH_BOOST = 2.0f;
