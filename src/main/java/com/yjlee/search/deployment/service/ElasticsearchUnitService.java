...
public class ElasticsearchUnitService {
   ...
   * @return 단위 사전 내용
   */
  public String getUnitDictionaryContent(DictionaryEnvironmentType environment) {
   ...
   * @param environment 환경 타입
   */
  public void updateUnitDictionary(String version, DictionaryEnvironmentType environment)
      throws IOException {
