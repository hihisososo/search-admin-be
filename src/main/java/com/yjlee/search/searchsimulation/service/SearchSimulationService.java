package com.yjlee.search.searchsimulation.service;
...
public class SearchSimulationService {

  private final ElasticsearchClient esClient;
  private final IndexMetadataRepository indexMetadataRepository;
  private final SearchSimulationQueryRepository searchQueryRepository;
  ...
  /** 검색 실행 */
  public SearchSimulationExecuteResponse executeSearch(SearchSimulationExecuteRequest request) {
    log.info(
    ...
    try {
      ...
      return SearchSimulationExecuteResponse.builder()
  ...
  /** 검색식 생성 */
  @Transactional
  public SearchSimulationQueryResponse createSearchQuery(
    ...
    SearchSimulationQuery searchQuery =
        SearchSimulationQuery.builder()
    ...
    SearchSimulationQuery saved = searchQueryRepository.save(searchQuery);
  ...
  /** 검색식 목록 조회 */
  @Transactional(readOnly = true)
  public PageResponse<SearchSimulationQueryListResponse> getSearchQueries(
    ...
    Page<SearchSimulationQuery> queryPage;
  ...
  /** 검색식 상세 조회 */
  @Transactional(readOnly = true)
  public SearchSimulationQueryResponse getSearchQueryDetail(Long queryId) {
  ...
  /** 검색식 수정 */
  @Transactional
  public SearchSimulationQueryResponse updateSearchQuery(
      Long queryId, SearchSimulationQueryUpdateRequest request) {
    log.info("검색식 수정 요청: {}", queryId);

    SearchSimulationQuery existing =
        searchQueryRepository
            .findById(queryId)
            .orElseThrow(() -> new IllegalArgumentException("존재하지 않는 검색식입니다: " + queryId));
    ...
    SearchSimulationQuery updated = searchQueryRepository.save(existing);
  ...
  private SearchSimulationQueryResponse toSearchQueryResponse(SearchSimulationQuery entity) {
    return SearchSimulationQueryResponse.builder()
        .id(entity.getId())
        .name(entity.getName())
  ...
  private SearchSimulationQueryListResponse toSearchQueryListResponse(
      SearchSimulationQuery entity) {
    return SearchSimulationQueryListResponse.builder()
        .id(entity.getId())
        .name(entity.getName())
        .description(entity.getDescription())
        .indexName(entity.getIndexName())
