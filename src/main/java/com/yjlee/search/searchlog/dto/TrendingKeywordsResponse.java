...
public class TrendingKeywordsResponse {
  ...
  @Schema(description = "현재 기간 시작", example = "2024-01-01T00:00:00Z")
  private LocalDateTime currentFromDate;

  @Schema(description = "현재 기간 종료", example = "2024-01-07T23:59:59Z")
  private LocalDateTime currentToDate;

  @Schema(description = "비교 기간 시작", example = "2023-12-25T00:00:00Z")
  private LocalDateTime previousFromDate;

  @Schema(description = "비교 기간 종료", example = "2023-12-31T23:59:59Z")
