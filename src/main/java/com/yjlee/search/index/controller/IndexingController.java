...
public class IndexingController {
  ...
  public ResponseEntity<Map<String, Object>> indexAllProducts() {
    try {
      log.info("API를 통한 상품 색인 시작");
      int totalIndexed = indexingService.indexAllProducts();
      ...
      return ResponseEntity.ok(
          Map.of(
              ...
              "averageRate", stats.getAverageRate(),
              "durationSeconds", stats.getTotalDuration().toSeconds()));
    } catch (IOException e) {
